...
/* harmony import */ var _submission_complete_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./submission-complete/component */ "./src/app/submission-complete/component.ts");
...
var routes = [
    ...
    { path: "submitted", component: _submission_complete_component__WEBPACK_IMPORTED_MODULE_4__["SubmissionCompleteComponent"] },
];
...
/* harmony import */ var _submission_complete_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./submission-complete/component */ "./src/app/submission-complete/component.ts");
    ...
    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["NgModule"])({
            declarations: [
                ...
                _submission_complete_component__WEBPACK_IMPORTED_MODULE_25__["SubmissionCompleteComponent"]
            ],
            imports: [
...
var BallsIntoBinsComponent = /** @class */ (function () {
    ...
    BallsIntoBinsComponent.prototype.ngOnChanges = function (changes) {
        ...
        var binInputChanged = (changes['values'] && !changes['values'].firstChange) ||
            (changes['fixedBins'] && !changes['fixedBins'].firstChange);
        var initialCountsChanged = changes['initialCounts'] && !changes['initialCounts'].firstChange;
     ...
     */
    BallsIntoBinsComponent.prototype.syncBinsAndCounts = function () {
        var _this = this;
        this.bins = this.computeBinsForInputs();
        var reconciled = this.reconcileCounts(this.initialCounts, this.bins.length);
        ...
        if (this.bins.length > 0 && reconciled.length !== this.initialCounts.length) {
            Promise.resolve().then(function () { return _this.countsChange.emit(_this.counts.slice()); });
        }
    };
    /**
     ...
     * (Mechanism 1)
     */
    BallsIntoBinsComponent.prototype.computeBinsForInputs = function () {
        if (this.fixedBins.length > 0)
            return this.fixedBins;
        if (this.values.length > 0)
            return this.binningService.computeBins(this.values);
        return [];
    };
    /**
     ...
     */
    BallsIntoBinsComponent.prototype.reconcileCounts = function (source, n) {
        if (n === 0)
            return [];
        if (source.length === n)
            return source.slice();
        var fitted = this.binningService.emptyCountsFor(n);
        var overlap = Math.min(n, source.length);
        for (var i = 0; i < overlap; i++)
            fitted[i] = source[i];
        return fitted;
    };
    BallsIntoBinsComponent.prototype.trackByBinIndex = function (index) {
        return index;
    };
...
module.exports = "/** Paddings */\n.p-xs {\n  padding: 4px;\n}\n.p-sm {\n  padding: 8px;\n}\n.p-0 {\n  padding: 0px !important;\n}\n/** Margins */\n.m-xs {\n  margin: 4px;\n}\n.m-sm {\n  margin: 8px;\n}\n.mb-sm {\n  margin-bottom: 8px;\n}\n.m-0 {\n  margin: 0px !important;\n}\n.m-b-0 {\n  margin-bottom: 0px !important;\n}\n.m-t-sm {\n  margin-top: 8px !important;\n}\n.m-t-md {\n  margin-top: 16px !important;\n}\n.m-b-md {\n  margin-bottom: 16px !important;\n}\n/** Multiple COLUMNS and ROWS */\n.h-full {\n  height: calc(100vh - 55px) !important;\n}\n.w-100 {\n  width: 100% !important;\n}\n.h-100 {\n  height: 100% !important;\n}\n.border-light {\n  border: 1px solid #dddddd !important;\n  border-radius: 3px;\n}\n.text-nowrap {\n  white-space: nowrap;\n}\n.list-group-item {\n  border: none;\n  padding: 10px;\n}\n.list-group-item .title {\n  margin-top: 5px;\n  margin-bottom: 12px;\n  font-weight: 400;\n  color: black;\n}\n/** Color Legend */\n.sequential-color-legend {\n  height: 12px;\n  border-radius: 3px;\n  background-image: linear-gradient(to right, #eeeeee, #42a5f5);\n}\n.divergent-color-legend {\n  height: 12px;\n  border-radius: 3px;\n  background-image: linear-gradient(to right, #ef9a9a, #eeeeee, #a5d6a7);\n}\n/** ROW: Multiple Headers */\n.title {\n  font-weight: 500 !important;\n}\n/** ROW: Multiple Buttons */\n.float-right {\n  float: right;\n}\n/** ROW: Encodings */\n.display-inline {\n  display: inline-block;\n}\n/** ROW: Filters */\n.q-filter-slider nouislider {\n  margin-top: 3em;\n  margin-bottom: 2.5em;\n  margin-left: 5%;\n  width: 90%;\n  font-size: 0.8em;\n}\n/** ROW: Selected Objects */\n.single-table {\n  padding: 0.25em 1.25em 0 1.25em;\n}\n.single-table > *:first-child {\n  padding: 0px;\n}\n.single-table > *:last-child {\n  border-right: 0px;\n}\n.attr-col {\n  padding: 0 0 0 1%;\n  border-right: 2px solid #dddddd;\n}\n.attr-col > table {\n  width: 98%;\n}\n.attr-row {\n  border-bottom: 1px solid #dddddd;\n}\n.attr-row:last-child {\n  border: 0px;\n}\n.attr-row:hover {\n  background-color: #dddddd !important;\n}\n.attr-row > td {\n  border: 0px;\n  padding: 0 0.4em 0 0.2em !important;\n}\n.group-table {\n  font-size: 0.9em;\n  text-align: center;\n}\n.group-table > table {\n  border-collapse: collapse;\n  position: relative;\n}\n.group-table-item:hover {\n  color: black !important;\n  background-color: #dddddd !important;\n}\n.group-table-header > th {\n  background-color: white;\n  top: 0; /* Don't forget this, required for the stickiness */\n  position: sticky;\n  box-shadow: 0 0 1px 0 rgba(0, 0, 0, 0.4);\n}\n.group-table-header > th,\n.group-table-item > td {\n  padding: 0 0.25em;\n  border-right: 1px solid #dddddd;\n}\n.group-table-header > th:last-child,\n.group-table-item > td:last-child {\n  border-right: 0px;\n}\n/** COLUMN: Awareness Panel */\n.card {\n  border: 0px;\n}\n.card-border {\n  border: 1px solid #333333;\n}\n.card-header {\n  background-color: white;\n  border-bottom: 0;\n  padding: 4px;\n}\n.card-header-hover:hover {\n  cursor: pointer;\n}\n/** CSS for dynamic DOM elements */\n::ng-deep {\n  /** Task Configuration Vis */\n  /** Plot */\n}\n::ng-deep body {\n  overflow: hidden !important;\n}\n::ng-deep .selected {\n  stroke: black;\n}\n::ng-deep .selected-item {\n  border-radius: 6px !important;\n  background: #999 !important;\n  border: 1px solid #ccc !important;\n  margin-bottom: 4px !important;\n  font-size: 0.9rem;\n}\n::ng-deep .dropdown-down,\n::ng-deep .dropdown-up {\n  border-left: 6px solid transparent !important;\n  border-right: 6px solid transparent !important;\n}\n::ng-deep .dropdown-down {\n  border-top: 8px solid #999 !important;\n}\n::ng-deep .dropdown-up {\n  border-bottom: 8px solid #999 !important;\n}\n::ng-deep .multiselect-item-checkbox input[type=checkbox] + div:before {\n  border: 2px solid #999 !important;\n}\n::ng-deep .multiselect-item-checkbox input[type=checkbox]:checked + div:before {\n  background: #999 !important;\n}\n::ng-deep .noUi-target {\n  height: 5px !important;\n}\n::ng-deep .noUi-base:hover {\n  cursor: pointer;\n}\n::ng-deep .noUi-connect {\n  height: 5px !important;\n  background: #999 !important;\n}\n::ng-deep .noUi-connect:hover {\n  cursor: pointer;\n}\n::ng-deep .noUi-handle {\n  width: 15px !important;\n  height: 20px !important;\n  padding: 0 !important;\n  margin: 0 !important;\n}\n::ng-deep .noUi-handle:hover {\n  cursor: pointer;\n}\n::ng-deep .noUi-horizontal .noUi-handle {\n  top: -9px !important;\n  right: -8px !important;\n}\n::ng-deep .noUi-tooltip {\n  padding: 2px;\n  background: #999;\n  border: 1px solid #ccc;\n  color: white;\n}\n::ng-deep .noUi-tooltip:hover {\n  cursor: pointer;\n}\n::ng-deep .noUi-handle:after,\n::ng-deep .noUi-handle:before {\n  display: none;\n}\n::ng-deep .noUi-pips-horizontal {\n  padding: 4px;\n}\n::ng-deep .noUi-value-large {\n  top: 0px !important;\n}\n::ng-deep .noUi-marker-large {\n  height: 8px !important;\n}\n::ng-deep .taskConfigVis .line {\n  fill: none;\n  stroke: steelblue;\n  stroke-width: 1.5px;\n}\n::ng-deep .taskConfigVis circle {\n  fill: steelblue;\n  fill-opacity: 1;\n  stroke-width: 1.5px;\n  cursor: move;\n}\n::ng-deep .taskConfigVis .tick line {\n  stroke: #eeeeee;\n}\n::ng-deep .unsupported-text {\n  font-size: 1.1em;\n  font-weight: 500 !important;\n}\n::ng-deep .post text {\n  font-size: 0.7em;\n  font-weight: 800 !important;\n}\n::ng-deep .tick text,\n::ng-deep .tick text {\n  font-size: 0.9em;\n}\n::ng-deep .x.axis.title text,\n::ng-deep .y.axis.title text {\n  font-size: 1.15em;\n  font-weight: 800 !important;\n}\n::ng-deep .legend text {\n  font-size: 0.8em;\n  font-weight: 800 !important;\n}\n::ng-deep .deviant-scrollbars > .os-scrollbar-horizontal {\n  top: 0;\n  right: 0;\n  bottom: auto;\n  left: 10;\n  height: 12px;\n}\n::ng-deep .deviant-scrollbars > .os-scrollbar-vertical {\n  left: 0;\n  bottom: 0;\n  right: auto;\n  top: 10;\n  width: 12px;\n}\n::ng-deep .deviant-scrollbars.os-host-scrollbar-horizontal-hidden > .os-scrollbar-vertical {\n  top: 0;\n}\n::ng-deep .deviant-scrollbars.os-host-scrollbar-vertical-hidden > .os-scrollbar-horizontal {\n  left: 0;\n}\n::ng-deep .os-theme-dark.os-theme-dark-edgy > .os-scrollbar > .os-scrollbar-track > .os-scrollbar-handle {\n  border-radius: 0px;\n}\n::ng-deep .offset-scrollbars > .os-scrollbar-vertical {\n  top: 35px;\n}\n::ng-deep .offset-scrollbars > .os-scrollbar-horizontal {\n  left: 15px;\n}\n/** Selected Subjects Panel */\n.selected-subjects-panel {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n.selected-subjects-header {\n  margin-bottom: 10px;\n  flex-shrink: 0;\n}\n.subject-hint {\n  font-size: 0.78rem;\n  color: #999;\n  margin-bottom: 8px;\n  flex-shrink: 0;\n}\n.subject-list {\n  display: flex;\n  flex-direction: column;\n  gap: 1px;\n  /* reserve room for all 10 rows so the submit button below never shifts as teens are added */\n  min-height: calc(10 * (1.3em + 12px + 1px));\n}\n.subject-row {\n  display: flex;\n  align-items: center;\n  padding: 6px 8px;\n  border-radius: 6px;\n  gap: 8px;\n  cursor: default;\n  transition: background 0.1s;\n}\n.subject-row:hover {\n  background: #e8f4fd;\n  outline: 1.5px solid #3498db;\n}\n.subject-row:hover .subject-remove {\n  opacity: 1;\n}\n.subject-row:hover .subject-name {\n  color: #1a6fa8;\n}\n.subject-index {\n  font-size: 0.78rem;\n  color: #aaa;\n  min-width: 18px;\n  text-align: right;\n  flex-shrink: 0;\n}\n.subject-name {\n  flex: 1;\n  font-size: 0.85rem;\n  font-weight: 500;\n  color: #222;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n.subject-submit-btn {\n  display: block;\n  width: 100%;\n  margin-top: 12px;\n  flex-shrink: 0;\n}\n.confirm-modal-backdrop {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background: rgba(20, 20, 20, 0.45);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  z-index: 2000;\n}\n.confirm-modal-panel {\n  background: white;\n  border: 1.5px solid #1a1a1a;\n  border-radius: 4px;\n  box-shadow: 6px 6px 0 rgba(0, 0, 0, 0.12);\n  padding: 20px;\n  max-width: 360px;\n}\n.confirm-modal-title {\n  font-weight: 700;\n  font-size: 1rem;\n  margin-bottom: 8px;\n}\n.confirm-modal-body {\n  font-size: 0.85rem;\n  color: #444;\n  line-height: 1.5;\n  margin-bottom: 16px;\n}\n.confirm-modal-actions {\n  display: flex;\n  justify-content: flex-end;\n  gap: 8px;\n}\n.subject-remove {\n  background: none;\n  border: none;\n  padding: 0 2px;\n  font-size: 0.7rem;\n  color: #bbb;\n  cursor: pointer;\n  opacity: 0;\n  transition: opacity 0.1s, color 0.1s;\n  flex-shrink: 0;\n}\n.subject-remove:hover {\n  color: #e74c3c;\n}\n.subject-empty {\n  font-size: 0.82rem;\n  color: #bbb;\n  text-align: center;\n  padding-top: 24px;\n}\n.separator {\n  margin-top: 8px;\n  margin-bottom: 4px;\n}\n.control-filter-panel .form-group {\n  margin-bottom: 0;\n}\n.control-filter-panel .form-label {\n  display: flex;\n  align-items: center;\n  width: 100%;\n  padding: 8px 10px;\n  margin: 0;\n  font-size: 0.82rem;\n  font-weight: 500;\n  color: #1a1a1a;\n  background: #f8f8f8;\n  border: 1px solid #e8e8e8;\n  border-radius: 4px;\n  cursor: pointer;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n          user-select: none;\n  transition: background 0.1s;\n}\n.control-filter-panel .form-label:hover {\n  background: #f0f0f0;\n}\n.control-filter-panel .form-label i {\n  margin-right: 6px;\n  color: #888;\n  font-size: 0.7rem;\n}\n.control-filter-panel .q-filter-slider,\n.control-filter-panel ng-multiselect-dropdown {\n  display: block;\n  background: white;\n  border: 1px solid #e8e8e8;\n  border-top: none;\n  border-radius: 0 0 4px 4px;\n  margin-bottom: 6px;\n  margin-top: 0;\n  padding: 0;\n}\n.control-filter-panel .q-filter-slider .multiselect-dropdown,\n.control-filter-panel ng-multiselect-dropdown .multiselect-dropdown {\n  margin: 0;\n  padding: 4px 8px;\n}\n.control-filter-panel hr.separator {\n  display: none;\n}\n#collapseAttributeControls,\n#collapseAwarenessControls {\n  background: #f5f5f5;\n}\n.textLight {\n  color: #ffffff !important;\n}\n.textDark {\n  color: #000000 !important;\n}\n/* TEMP DEBUG: live metrics overlay (Logs panel). Deliberately looks like a\n   debug overlay, not a polished feature. Remove with the rest of the feature. */\n.logs-panel {\n  position: fixed;\n  bottom: 12px;\n  right: 12px;\n  z-index: 2000;\n  width: 260px;\n  max-height: 70vh;\n  overflow-y: auto;\n  padding: 8px 10px;\n  background: rgba(20, 20, 20, 0.92);\n  color: #e6e6e6;\n  border: 1px solid #444;\n  border-radius: 4px;\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.4);\n  font-family: \"SFMono-Regular\", Consolas, \"Liberation Mono\", Menlo, monospace;\n  font-size: 11px;\n  line-height: 1.4;\n}\n.logs-panel__header {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  margin-bottom: 6px;\n  font-weight: 700;\n  text-transform: uppercase;\n  letter-spacing: 0.04em;\n  color: #9ad;\n}\n.logs-panel__close {\n  background: none;\n  border: none;\n  color: #ccc;\n  font-size: 15px;\n  line-height: 1;\n  cursor: pointer;\n  padding: 0 2px;\n}\n.logs-panel__close:hover {\n  color: #fff;\n}\n.logs-panel__section {\n  margin: 6px 0 3px;\n  padding-top: 4px;\n  border-top: 1px solid #444;\n  font-weight: 700;\n  color: #ffd479;\n}\n.logs-panel__subsection {\n  margin: 4px 0 2px;\n  color: #9ad;\n}\n.logs-panel__row {\n  display: flex;\n  justify-content: space-between;\n  gap: 8px;\n}\n.logs-panel__row span:first-child {\n  color: #aaa;\n}\n.logs-panel__row span:last-child {\n  color: #fff;\n}\n.logs-panel__empty {\n  color: #c88;\n  font-style: italic;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MainActivityComponent = /** @class */ (function () {
     ...
     */
    MainActivityComponent.prototype.panelValue = function (attr) {
        var ds = this.appConfig[this.global.appMode];
        var ho = ds['hoveredObject'];
        if (attr === ds['xVar'] && ho['jitter_xVal'] != null)
            return Math.round(ho['jitter_xVal'] * 10) / 10;
        if (attr === ds['yVar'] && ho['jitter_yVal'] != null)
            return Math.round(ho['jitter_yVal'] * 10) / 10;
        return ho[attr]; // true value for all other columns, and when no jitter stored
    };
    MainActivityComponent.prototype.getSubmissionStorageKey = function () {
        return "lumos_submitted_" + this.global.participantId;
    };
    MainActivityComponent.prototype.confirmSubmit = function () {
        this.showSubmitConfirm = true;
    };
    MainActivityComponent.prototype.cancelSubmit = function () {
        this.showSubmitConfirm = false;
    };
    MainActivityComponent.prototype.submitTask = function () {
        this.showSubmitConfirm = false;
        var ids = Object.keys(this.appConfig[this.global.appMode]['selectedObjects']);
        var verificationCode = this.utilsService.generateVerificationCode(this.global['participantId']);
...
var ChatService = /** @class */ (function () {
    ...
    ChatService.prototype.sendTaskSubmission = function (payload) {
...
var UtilsService = /** @class */ (function () {
     ...
     */
    UtilsService.prototype.generateVerificationCode = function (participantId) {
        var hash = 5381;
        for (var i = 0; i < participantId.length; i++) {
            hash = ((hash * 33) ^ participantId.charCodeAt(i)) >>> 0;
        }
        var code = hash.toString(36).toUpperCase().padStart(6, "0");
        return "LX-" + code;
    };
    /**
...
/***/ "./src/app/submission-complete/component.html":
/*!****************************************************!*\
  !*** ./src/app/submission-complete/component.html ***!
  \****************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"submission-complete-page\">\n  <div class=\"submission-complete-card\">\n    <h2>Task submitted</h2>\n    <p>Thank you for completing the task. Copy the verification code below and submit it to confirm your participation.</p>\n    <div class=\"submission-complete-code\">{{ verificationCode }}</div>\n  </div>\n</div>\n"

/***/ }),

/***/ "./src/app/submission-complete/component.scss":
/*!****************************************************!*\
  !*** ./src/app/submission-complete/component.scss ***!
  \****************************************************/
/*! no static exports found */
...
module.exports = ".submission-complete-page {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 100vw;\n  height: 100vh;\n  background: #fff;\n}\n\n.submission-complete-card {\n  text-align: center;\n  max-width: 400px;\n  padding: 24px;\n}\n\n.submission-complete-card h2 {\n  margin: 0 0 12px;\n  font-size: 1.3rem;\n  font-weight: 600;\n  color: #1a1a1a;\n}\n\n.submission-complete-card p {\n  color: #666;\n  font-size: 0.88rem;\n  line-height: 1.5;\n  margin-bottom: 20px;\n}\n\n.submission-complete-code {\n  font-family: \"JetBrains Mono\", monospace;\n  font-size: 1.2rem;\n  letter-spacing: 0.05em;\n  border: 1px solid #ddd;\n  border-radius: 4px;\n  padding: 10px 16px;\n  color: #1a1a1a;\n  -webkit-user-select: all;\n     -moz-user-select: all;\n          user-select: all;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/submission-complete/component.ts":
/*!**************************************************!*\
  !*** ./src/app/submission-complete/component.ts ***!
  \**************************************************/
/*! exports provided: SubmissionCompleteComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SubmissionCompleteComponent", function() { return SubmissionCompleteComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
var SubmissionCompleteComponent = /** @class */ (function () {
    function SubmissionCompleteComponent(router, global, utilsService) {
        this.router = router;
        this.global = global;
        this.utilsService = utilsService;
        this.verificationCode = "";
    }
    SubmissionCompleteComponent.prototype.ngOnInit = function () {
        var key = "lumos_submitted_" + this.global.participantId;
    ...
    SubmissionCompleteComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: "app-submission-complete",
            template: __webpack_require__(/*! ./component.html */ "./src/app/submission-complete/component.html"),
            styles: [__webpack_require__(/*! ./component.scss */ "./src/app/submission-complete/component.scss")]
        }),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            _models_config__WEBPACK_IMPORTED_MODULE_3__["SessionPage"],
            _services_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilsService"]])
    ], SubmissionCompleteComponent);
    return SubmissionCompleteComponent;
}());
...
function translatePoints(d, context, xIsQ, yIsQ) {
    ...
    var sameVariable = dataset["xVar"] === dataset["yVar"];
    if (context.userConfig.jitterScatterplotPoints && !sameVariable) {
        ...
        if (xIsQ) {
            ...
            var xJF = (_a = dataset["attributes"][dataset["xVar"]]["jitterFactor"]) !== null && _a !== void 0 ? _a : Q_JITTER;
        ...
        if (yIsQ) {
            ...
            // Per-attribute jitter factor; ?? (not ||) so a deliberate 0 is honored.
            var yJF = (_b = dataset["attributes"][dataset["yVar"]]["jitterFactor"]) !== null && _b !== void 0 ? _b : Q_JITTER;
...
module.exports = __webpack_require__(/*! /Users/lestermartin/Projects/CAV/Lumos-LLM/Lumos/app/src/main.ts */"./src/main.ts");
